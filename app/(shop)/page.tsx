...
export default function Home() {
  return (
    <main className="bg-black">
      <section className="relative h-[75vh] overflow-hidden bg-black md:h-screen md:min-h-[560px]">
        <div
        ...
        <div className="relative z-10 flex h-full items-start md:items-center px-6 sm:px-8 md:px-14 lg:px-20 pt-10 sm:pt-12 md:pt-0">
